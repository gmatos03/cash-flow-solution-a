package com.cashflow.ledger.reporting.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openApi() {
        return new OpenAPI()
                .info(new Info()
                        .title("Cash Flow Control - Reporting Service")
                        .description("Builds the daily cash-flow log: aggregates ledger_entries, upserts daily_cash_flow_log, renders CSV/PDF locally. See Appendix F.7.")
                        .version("1.0.0")
