...
public class OpenApiConfig {
    ...
    public OpenAPI openApi() {
        return new OpenAPI()
                .info(new Info()
                        .title("Cash Flow Control - Command Service")
                        .description("Write side of Solution A (Event Sourcing + CQRS). Validates and appends ledger entries, publishes credit/debit events to Kafka. See Appendix F.2.")
                        .version("1.0.0")
